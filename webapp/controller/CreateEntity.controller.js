sap.ui.define([
	"ztest500/controller/BaseController",
	...
	return BaseController.extend("ztest500.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("ALVSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("ALVSet", oData);
